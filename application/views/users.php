                ...
                <?php echo form_open(base_url()."index.php/Users/ajout",array('id'=>'form_ajout_user','class'=>'m-t','role'=>'form'));?>
                    <div class="tab-content">
                        <div id="step1" class="p-m tab-pane active">
                            ...
                            <div id='privileges' class='row mt-1'>
                                <div class="col-12 text-left">
                                    <div class="row">
                                        <div class="col-6">
                                            <h5 style='text-decoration: underline'>Pages</h5>
                                            <div class="text-left">
                                                <input id='6' type="checkbox" name='privileges[]' value=6> Courrier
                                            </div>
                                            <div class="text-left">
                                                <input id='7' type="checkbox" name='privileges[]' value=7> Utilsateurs
                                            </div>
                                            <div class="text-left">
                                                <input id='9' type="checkbox" name='privileges[]' value=9> Contact
                                            </div>
                                            <div class="text-left">
                                                <input id='8' type="checkbox" name='privileges[]' value=8> Corbeil
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            ...
                                            <div class="text-left">
                                                <input id='4' type="checkbox" name='privileges[]' value=4> Restaurer | Corbeille
                                            </div>
                                            <div class="text-left">
                                                <input id='5' type="checkbox" name='privileges[]' value=5> Statut | Utilsateurs
                                            </div>
                                        </div>
                                    </div>
                                </div>
